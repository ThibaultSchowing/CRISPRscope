...
# 
RMK202_rawIllumina_bwamem_sorted_mapped_mapQ_30_out <- RMK202_rawIllumina_bwamem_sorted_mapped_mapQ_30 %>% mutate(add = str_extract(V13, "[0-9]+")) %>% mutate_at('add',as.numeric) %>% filter(.,add>25 & add<42) %>% select(-"add")
