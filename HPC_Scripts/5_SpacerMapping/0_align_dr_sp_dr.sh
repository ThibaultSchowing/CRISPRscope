...
sed -e "s///" ${script_locations}/spacer_mapping_file.bed > ${script_locations}/spacer_mapping_file.bed

# ATTENTION: remove whitespaces "^M" from the file before
#  -> ctrl-v ctrl-m
...
rm ${BaseLocation_output}/final/allSamples_protospacer_coverage.bed
rm ${BaseLocation_output}/final/allSamples_spacer_coverage.bed
