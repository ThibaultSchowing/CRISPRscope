...
clusteridentity = sys.argv[3]
print("cluster identity: " + clusteridentity)
...
with open(INDIR + "/" + filename) as fasta_file:  # Will close handle cleanly
        identifiers = []
        seqlist = []
...
outputdf.to_csv("./OUTPUT/Clusters"+ clusteridentity +"_" + filebasename + ".csv", sep = ',', header = True, index = False)
