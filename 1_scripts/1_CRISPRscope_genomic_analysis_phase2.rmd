...
saveRDS(CRISPRscope_tbl_185, file = paste(data_folder, "/IMPORT_EXPORT/export_complete_SEL185.rds", sep=""))
saveRDS(CRISPRscope_tbl_26, file = paste(data_folder, "/IMPORT_EXPORT/export_complete_SEL26.rds", sep=""))
```
...
ANI_Shared_spacers_strain_pair %>% 
  write.csv(file = paste(data_folder, "/IMPORT_EXPORT/ANI_Shared_spacers_strain_pair.csv", sep=""), row.names=FALSE)
...
```{r fig.height=8, fig.width=15}
ANI_Shared_spacers_strain_pair <- read_csv(file = paste(data_folder, "/IMPORT_EXPORT/ANI_Shared_spacers_strain_pair.csv", sep="")) # 21 species
...
ANI_Shared_spacers_strain_pair_filtered %>% write.csv(file = paste(data_folder, "/IMPORT_EXPORT/ANI_data_plot.csv", sep=""))
...
ANI_Shared_spacers_strain_pair_filtered <- read_csv(file = paste(data_folder, "/IMPORT_EXPORT/ANI_data_plot.csv", sep="")) %>% 
